...
export const theme = { // eslint-disable-line no-shadow
  ...
  outlineShadow: '0 0 3px 1px rgba(35, 35, 35, 0.28)',
  outlineShadow2: '0 1px 20px 0px hsla(0, 0%, 0%, 0.29), 0 1px 5px 0px hsla(0, 0%, 0%, 0.18)',
  // focusHighlight: 'Highlight',
  // focusHighlightText: 'HighlightText',
  focusHighlight: lighten(palette.accent.main, 0.85),
  focusHighlightText: palette.accent.main,
  transition: {
